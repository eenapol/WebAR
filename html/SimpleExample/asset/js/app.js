//             别间隔时间(毫秒), 识别服务地址
const webAR = new WebAR(1000, 'https://cn1-crs.easyar.com:8443/search','cAtj21a/ROonle+dsbfe1Rfn02cwTQ2hTOvxnIVBefcQQ+l1JgMRAnbfr97YBsObdQ1qcClcO94+e9zVUgKOwQ==');
// 列出并打开设备上的摄像头
...
document.querySelector('#start').addEventListener('click', () => {
    webAR.startRecognize((msg) => {
        //console.info(msg);
		console.log('识别成功1111111111111111');
        alert('识别成功');
    });
}, false);
// 暂停识别
